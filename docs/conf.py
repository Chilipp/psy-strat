...
example_gallery_config = dict(
    urls='https://github.com/Chilipp/psy-strat/blob/master/examples',
    )
...
not_document_data = ['psy_strat.plugin.defaultParams',
                     'psy_strat.plugin.rcParams']
...
version = re.match('\d+\.\d+\.\d+', psy_strat.__version__).group()
# The full version, including alpha/beta/rc tags.
release = psy_strat.__version__
...
htmlhelp_basename = 'psy-stratdoc'
...
latex_documents = [
  (master_doc, 'psy-strat.tex', u'psy-strat Documentation',
...
man_pages = [
    (master_doc, 'psy-strat', u'psy-strat Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'psy-strat', u'psy-strat Documentation',
   author, 'psy-strat', 'The psyplot plugin for simple visualizations',
   'Miscellaneous'),
]
